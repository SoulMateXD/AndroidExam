...
public class MusicRecyclerAdapter extends RecyclerView.Adapter<MusicRecyclerAdapter.ViewHolder>
    ...
    public MusicRecyclerAdapter(ArrayList<Music> datalist){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view){
            super(view);
            albumpic = (ImageView)view.findViewById(R.id.music_item_img);
            songName = (TextView)view.findViewById(R.id.music_item_song_name);
            singerName = (TextView)view.findViewById(R.id.music_item_singer_name);
            playImg = (TextView)view.findViewById(R.id.music_item_play);
        }
    }
